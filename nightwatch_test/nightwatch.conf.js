require('env2')('sample.env'); // optionally store youre Evironment Variables in .env
...
const config = { // we use a nightwatch.conf.js file so we can include comments and helper functions
  ...
  "output_folder": "data/output", // reports (test outcome) output by nightwatch
  "selenium": {
    "start_process": true,
  ...
  "test_workers" : {"enabled" : true}, // perform tests in parallel where possible
  "test_settings": {
    "default": {
